...
export default function Page() {
  ...
  return (
    <div className="flex min-h-full bg-gray-100 text-gray-900">
      ...
      {/* <Sidebar /> */}
      {/* Main Content */}
      <div className="flex-1 min-h-full flex flex-col overflow-hidden">
        {/* Header */}
        {/* Board */}
        <main
          className="flex-1 min-h-full overflow-x-auto overflow-y-hidden"
          style={{
        ...
        >
          <div className="flex flex-col min-h-full md:flex-row items-center md:items-start px-6 py-8 md:space-x-6 ">
